...
public class SSValues {
    public static final int AUTO_ARM_OFFSET = 455;
    ...
    public static final int ARM_SLIGHTLY_HIGHER = 300;
    ...
    public static final int SLIDE_INTAKE_FAR = (int)(maxValue*0.57);
    public static final int SLIDE_HIGH_CHAMBER_PLACE_AUTO = (int)(maxValue*0.51);
